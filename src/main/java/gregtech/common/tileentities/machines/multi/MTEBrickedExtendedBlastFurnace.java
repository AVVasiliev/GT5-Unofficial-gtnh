...
public class MTEBrickedExtendedBlastFurnace extends MTEPrimitiveExtendedBlastFurnace implements ISecondaryDescribable {
    ...
    public MTEBrickedExtendedBlastFurnace(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional);
    }
    public MTEBrickedExtendedBlastFurnace(String aName) {
        super(aName);
    }
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new MTEBrickedExtendedBlastFurnace(this.mName);
    }
    ...
    public String getName() {
        return "Bricked Giga Blast Furnace";
    }
