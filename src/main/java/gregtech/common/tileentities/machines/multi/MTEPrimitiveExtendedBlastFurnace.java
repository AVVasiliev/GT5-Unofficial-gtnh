...
public abstract class MTEPrimitiveExtendedBlastFurnace extends MetaTileEntity
    ...
    public MTEPrimitiveExtendedBlastFurnace(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional, INPUT_SLOTS + OUTPUT_SLOTS);
    }

    public MTEPrimitiveExtendedBlastFurnace(String aName) {
